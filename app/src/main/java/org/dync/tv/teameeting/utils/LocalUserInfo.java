...
public class LocalUserInfo {
    public static final String PREFERENCE_NAME = "tv_userinfo";
    public static final String MEETING_LIST_ENTITY = "meeting_list_entity";
    ...
    public void setUserStr(String str_name, String str_value) {
    ...
    public String getUserStr(String str_name) {
